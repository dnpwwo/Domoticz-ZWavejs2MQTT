...
class BasePlugin:
    ...
    def __init__(self):
        ...
        self.typeMapping = {
                    ...
                    "scene_state_scene_001":    {"type": "Push On", "suffix":"Scene 1", "update": self.updateScene },
                    "scene_state_scene_002":    {"type": "Push On", "suffix":"Scene 2", "update": self.updateScene },
                    "scene_state_scene_003":    {"type": "Push On", "suffix":"Scene 3", "update": self.updateScene },
                    "scene_state_scene_004":    {"type": "Push On", "suffix":"Scene 4", "update": self.updateScene },
                    "scene_state_scene_005":    {"type": "Push On", "suffix":"Scene 5", "update": self.updateScene },
                    "scene_state_scene_006":    {"type": "Push On", "suffix":"Scene 6", "update": self.updateScene },
                    "scene_state_scene_007":    {"type": "Push On", "suffix":"Scene 7", "update": self.updateScene },
                    "scene_state_scene_008":    {"type": "Push On", "suffix":"Scene 8", "update": self.updateScene },
